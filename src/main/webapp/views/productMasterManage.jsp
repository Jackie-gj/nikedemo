...
<table id="dg" title="商品主数据管理" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true" data-options="pageSize:30"
       url="${pageContext.request.contextPath}/productmaster/list.do"
       toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="matlNbr" width="10%" align="center">MATL_NBR</th>
        <th field="season" width="150" align="center">SEASON</th>
        <th field="omd" width="150" align="center" data-options="formatter:myformatter,parser:myparser">OMD</th>
        <th field="prodEngnDesc" width="150" align="center">PROD_ENGN_DESC</th>
        <th field="styleCd" width="150" align="center">STYLE_CD</th>
        <th field="matlLongNm" width="300" align="center">MATL_LONG_NM</th>
        <th field="colorCd" width="150" align="center">COLOR_CD</th>
    </tr>
    </thead>
</table>
<div id="tb">
    ...
    <div>
        &nbsp;关键字：&nbsp;<input type="text" id="searchOn" size="20"
...
<script type="text/javascript">
    ...
    function deleteData() {
        ...
        $.messager.confirm("系统提示", "您确认要删除这<font color=red>"
            ...
            if (r) {
                $.post("${pageContext.request.contextPath}/productmaster/delete.do",
                        {
                            ids: ids
                        }, function (result) {
                            if (result.success) {
    ...
    function openDataAddDialog() {
        $("#dlg").dialog("open").dialog("setTitle", "上传商品主数据");
       	url = "${pageContext.request.contextPath}/productmaster/upload.do";
    }
    ...
    function openModifyDialog() {
        ...
        $('#fm').form('load', row);
        url = "${pageContext.request.contextPath}/productmaster/save.do?id="
                + row.id;
    }
