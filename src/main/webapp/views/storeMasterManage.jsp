...
<table id="dg" title="店铺主数据管理" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true" data-options="pageSize:30"
       url="${pageContext.request.contextPath}/storemaster/list.do"
       toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="posId" width="10%" align="center">POS ID</th>
        <th field="storeSubType" width="300" align="center">Store Sub-Type</th>
        <th field="chinaStoreSubChannel" width="200" align="center">China Store Sub Channel</th>
        <th field="localStoreName" width="200" align="center">(Local) Store Name</th>
        <th field="abbrevOwnerGroupName" width="200" align="center">(Abbrev) Owner Group Name</th>
    </tr>
    </thead>
</table>
<div id="tb">
...
<script type="text/javascript">
    ...
    function deleteData() {
        ...
        $.messager.confirm("系统提示", "您确认要删除这<font color=red>"
            ...
            if (r) {
                $.post("${pageContext.request.contextPath}/storemaster/delete.do",
                        {
                            ids: ids
                        }, function (result) {
                            if (result.success) {
    ...
    function openDataAddDialog() {
        $("#dlg").dialog("open").dialog("setTitle", "上传店铺主数据");
       	url = "${pageContext.request.contextPath}/storemaster/upload.do";
    }
    ...
    function openModifyDialog() {
        ...
        $('#fm').form('load', row);
        url = "${pageContext.request.contextPath}/storemaster/save.do?id="
                + row.id;
    }
