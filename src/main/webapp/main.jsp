    ...
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 50px">
                <font color="grey" size="10">DEMO</font>
            </div>
        </div>
    </div>
</div>
<div region="west" style="width: 200px;height:500px;" title="导航菜单"
    ...
    <div class="easyui-accordion">
        ...
        <div title="模型结果" data-options="iconCls:'icon-shuji'"
             style="padding:10px">
            <a
                    href="javascript:openTab(' 模型结果','moduleResult.jsp','icon-tupians')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-tupian'"
                    style="width: 110px;">模型结果展示</a>
        </div>
        <div title="商品店铺管理" data-options="iconCls:'icon-shouye'"
             style="padding:10px">
            <a
                    href="javascript:openTab(' 商品主数据管理','productMasterManage.jsp','icon-tupians')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-tupian'"
                    style="width: 130px;"> 商品主数据管理</a>
            <a
                    href="javascript:openTab(' 店铺主数据管理','storeMasterManage.jsp','icon-tupians')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-tupian'"
                    style="width: 130px;"> 店铺主数据管理</a>
            <a
                    href="javascript:openTab(' CLC店铺主数据管理','clcDoorMasterManage.jsp','icon-tupians')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-tupian'"
                    style="width: 150px;"> CLC店铺主数据管理</a>
        </div>
        <div title="销售数据" data-options="iconCls:'icon-shuji'"
             style="padding:10px">
            <a
                    href="javascript:openTab(' 销售数据列表','saleInfoList.jsp','icon-tupians')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-tupian'"
                    style="width: 110px;">销售数据列表</a>
        </div>
        <!-- div title="书籍管理" data-options="iconCls:'icon-shuji'"
            ...
            <a
                    ...
                    style="width: 110px;">全部书籍</a>
        </div-->
			<div title="系统管理" data-options="iconCls:'icon-item'"
				style="padding: 10px;">
				<a href="javascript:openTab(' 管理员列表','userManage.jsp','icon-lxr')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-lxr'" style="width: 110px;">管理员列表</a><a
